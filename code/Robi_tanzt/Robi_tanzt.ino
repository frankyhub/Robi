...
************************************************************************************************* 
/*  03.09.2022
    RU.attach(12);    // Servo rechts oben an pin 8
    RL.attach(9);     // Servo rechts unten an pin 11 
    LU.attach(10);    // Servo links oben an pin pin 10 
    LL.attach(11);    // Servo links unten an pin 9 
*/
**************************************************************************************************/
...
//#include <Servo.h>
/*  03.09.2022
    RU.attach(12);    // Servo rechts oben an pin 12
    RL.attach(9);     // Servo rechts unten an pin 9 
    LU.attach(10);    // Servo links oben an pin pin 10 
    LL.attach(11);    // Servo links unten an pin 11 
*/    
